export default function WorkExperience() {
    return (
        <section class="px-5">
            <div>
                <h2 class="font-semibold text-3xl text-text-primary">Experience</h2>
                <p class="font-light text-md text-text-tertiary">Summary of my professional career</p>
            </div>
            <div class="mt-5">
                ...
                <div class="relative pl-5">
                    ...
                    <div class="absolute -left-[5px] top-2 h-3 w-3 rounded-full bg-green-400 animate-ping"></div>
                    <h4 class="font-light text-md text-text-tertiary pt-0.5">Now</h4>
                    <h3 class="font-medium text-lg text-text-secondary animate-pulse">To be continued</h3>
                </div>
            </div>
        </section>
    );
